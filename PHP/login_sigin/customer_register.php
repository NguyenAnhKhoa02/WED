...
<input type="text" class="form-control" name="c_user" required>
...
<i class="fa fa-check tick5"> </i>

<i class="fa fa-times cross5"> </i>
</span><!-- input-group-addon Ends -->
<input type="text" class="form-control birthday" id="birthday" name="c_birthday" placeholder="2000/02/20 or 2000-02-20" required>
